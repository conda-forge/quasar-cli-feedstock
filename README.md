...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/quasar-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/quasar-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install quasar-cli
```
...
It is possible to list all of the versions of `quasar-cli` available on your platform:
...
```
pixi search quasar-cli --channel conda-forge
```
